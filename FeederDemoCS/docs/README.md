...
Check for the latest [SDK](https://github.com/njz3/vJoy/tree/master/SDK/c%23).
...
Returns TRUE if `vJoyInterface.dll` file version and vJoy Driver version are identical, otherwise FALSE.
